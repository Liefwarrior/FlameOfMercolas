...
| `kit-dr-960x540.png` | `--kit=dr --settle-steps=0` | The clock at two. Fists on Ox Gullbane at the door, the coat on. His blow lands and the row says `COAT TURNS 2.` on the step it did. The body lost the rest. | Armor rating softening a hit | Flat DR per worn piece, floored at one, said once per blow. Coverage and wear are the v2 ceiling. |
...
| boots | BOOTS | 30 | 8 | feet | | | 1 | | drying on the quay, nobody's; a bouncer wears them |
