...
| `kit-dr-960x540.png` | `--kit=dr --settle-steps=0` | The clock at two. Fists on Ox Gullbane at the door, the coat on. His blow lands and `COAT TURNS 2` comes up in the centre stack on the step it did, its own row in the blocked wash's steel ink, held a plate's length. The body lost the rest. Ox's warning keeps the alert row, the house minds you. | Armor rating softening a hit | Flat DR per worn piece, floored at one, said once per blow. Coverage and wear are the v2 ceiling. |
