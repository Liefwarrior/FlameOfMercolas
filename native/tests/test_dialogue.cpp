...
TEST_CASE("the owner's bark tables load, all of them") {
    ...
    // the 18 in contract_barks.json (S6) plus the 14 court.* tables the
    // JUSTICE BUILD appended there (the bench: the officer walking you in,
    // the priest's four openings, the priest pressing for the plea, the
    // seven judgments, the lie), the 12 in house_barks.json (S7), the
