...
public final class Jobs {
    ...
    public static final List<Registration> ALL = sorted(List.of(
            ...
            // S8 craft yards: the anchor cycle with a YIELD bound to it (Job.Serf.CraftYard).
            new Registration(Job.Serf.CraftYard.Ropewalker.ID,
                    (p, c) -> new Job.Serf.CraftYard.Ropewalker(p)),
            new Registration(Job.Serf.CraftYard.Tarhand.ID,
                    (p, c) -> new Job.Serf.CraftYard.Tarhand(p)),
            new Registration(Job.Serf.CraftYard.Cooper.ID,
                    (p, c) -> new Job.Serf.CraftYard.Cooper(p)),
            new Registration(Job.Serf.CraftYard.Salter.ID,
                    (p, c) -> new Job.Serf.CraftYard.Salter(p)),
