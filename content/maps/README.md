...
- **Establishments.** K01–K35 per gazetteer §3/§3.1, every footprint individually pinned so
  ...
  nook on C4's rooftop-slum deck with no lamp, no sign, and no new door — reached only through
  roofhut_09's own door gap. Squall's Bathhouse holds real depth-2 pool water on the z:+11
  fluids sublayer; Brann's Chandlery has a z:+10 cellar (the gray ledger); the Drowned Hold is
  a floorless-in-places hulk over a flooded z:+10 undercellar. Street bands (Tarwalk, Saltgate
